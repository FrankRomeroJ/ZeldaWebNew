...
CREATE TABLE `departamentos` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_departamentos` (`paises_id`),
  CONSTRAINT `Fk_Departamentos_Paises` FOREIGN KEY (`paises_id`) REFERENCES `paises` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `departamentos` VALUES (1,208,'Ahuachapán'),(2,208,'Santa Ana'),(3,208,'Sonsonate'),(4,208,'La Libertad'),(5,208,'Chalatenango'),(6,208,'San Salvador'),(7,208,'Cuscatlán'),(8,208,'La Paz'),(9,208,'Cabañas'),(10,208,'San Vicente'),(11,208,'Usulután'),(12,208,'Morazán'),(13,208,'San Miguel'),(14,208,'La Unión');
...
CREATE TABLE `empresas` (
  ...
  CONSTRAINT `Fk_Contas_Departamentos` FOREIGN KEY (`departamento_id`) REFERENCES `departamentos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `Fk_Contas_Municipios` FOREIGN KEY (`municipio_id`) REFERENCES `municipios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `Fk_Contas_Paises` FOREIGN KEY (`pais_id`) REFERENCES `paises` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `municipios` (
  ...
  CONSTRAINT `Fk_Municipios_Departamentos` FOREIGN KEY (`departamento_id`) REFERENCES `departamentos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-11-08 10:01:21
